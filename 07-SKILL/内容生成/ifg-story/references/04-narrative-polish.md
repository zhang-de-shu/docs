...
- **节点连贯性铁律**：节点 narrative 开头必须「时空锚定 + 承接上拍」——先 1-2 句说清何时/何地/谁在，并接住上一节点结尾的悬念或动作；结尾收在未解决处喂给下一拍。判定基准：把任意节点的 narrative 单独抽给没玩过游戏的人看，他能说清"谁、在哪、正在发生什么"；把相邻两个节点连读，中间不需要读者脑补任何跳跃。entryState/exitState 必填，作为缝合依据。
